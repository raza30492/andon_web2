package in.andonsystem.servlets;

import in.andonsystem.DBase;
import in.andonsystem.models.Pair;
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(action.equals("add")){
                ...
                new MiscService().writeProperties(
                        getServletContext(),
            ...
            if(action.equals("showUsers")){
                ...
                if(page.equals("viewPage")){                
                    ...
                    for(Pair<Integer,String> item : list){
                        respText += "<tr>\n" +
                                    "       <td>" + item.getKey() +"</td>"+
                                    "       <td><a href=\"user?action=view&user_id="+item.getKey()+"\" >"+ item.getValue() +"</a></td>"+
                                    "</tr>";
                    }
                ...
                if(page.contains("remove")){                
                    ...
                    for(Pair<Integer,String> item : list){
                        respText += "<tr>\n" +
                                    "       <td>" + item.getKey() +"</td>"+
                                    "       <td>" + item.getValue() +"</td>"+
                                    "       <td><a class=\"btn btn-danger\" href=\"user?action=remove&user_id="+item.getKey()+"\" >Remove</a></td>"+
                                    "</tr>";
                    }
