...
public class Issue1 {
    ...
    public Issue1(int id, int line, int secId, int deptId, int probId, String critical, String operatorNo, String desc, long raisedAt, long ackAt, long fixAt, int raisedBy, int ackBy,int fixBy,int processingAt, int status, int seekHelp) {
        this.id = id;
        this.line = line;
        this.secId = secId;
        this.deptId = deptId;
