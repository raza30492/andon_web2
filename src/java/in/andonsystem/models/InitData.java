...
public class InitData {
    ...
    public InitData(long launchTime, long issueSync, int timeAck, int timeLevel1, int timeLevel2, int lines, List<Section> sections, List<Dept> departments, List<Problem> problems, List<Issue> issues, List<User> users, List<Desgn> desgns, List<KeyValue> desgnLine, List<KeyValue> desgnProblem) {
